...
<form method="post" action="admin-post.php">
		...
		<input type="hidden" name="action" value="<?php echo esc_attr( PLUGIN_UNDERSCORE ); ?>_save_network_options" />
		...
		<div id="tabs" class="azrcrv-ui-tabs">
			<ul class="azrcrv-ui-tabs-nav azrcrv-ui-widget-header" role="tablist">
				<li class="azrcrv-ui-state-default azrcrv-ui-state-active" aria-controls="tab-panel-settings" aria-labelledby="tab-settings" aria-selected="true" aria-expanded="true" role="tab">
					<?php // phpcs:ignore. ?>
					<a id="tab-settings" class="azrcrv-ui-tabs-anchor" href="#tab-panel-settings"><?php echo $tab_network_settings_label; ?></a>
				</li>
			...
			<div id="tab-panel-settings" class="azrcrv-ui-tabs-scroll" role="tabpanel" aria-hidden="false">
				<fieldset>
					<legend class='screen-reader-text'>
						<?php
						// phpcs:ignore.
						echo $tab_network_settings_label;
						?>
					</legend>
					<?php
					// phpcs:ignore.echo
					echo $tab_network_settings;
					?>
				</fieldset>
			</div>
	...
	<input type="submit" name="btn_save" value="<?php esc_html_e( 'Save Settings', 'azrcrv-cv' ); ?>" class="button-primary"/>
</form>
<?php
/*
...
<div class='azrcrv-donate'>
	<?php
		printf( esc_html__( 'Support %s', 'azrcrv-cv' ), esc_html( DEVELOPER_NAME ) );
	?>
