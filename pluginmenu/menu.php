 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_cv')){
	function azrcrv_create_plugin_menu_cv(){
		azrcrv_create_plugin_menu_table_cv();
		azrcrv_populate_plugin_menu_table_cv();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_cv')){
	function azrcrv_populate_plugin_menu_table_cv(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_cv')){
	function azrcrv_create_plugin_menu_table_cv(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
